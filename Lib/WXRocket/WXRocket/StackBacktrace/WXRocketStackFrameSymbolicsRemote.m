...
+ (NSError *)errorWithMessage:(NSString *)msg code:(NSInteger)code {
    ...
    return [NSError errorWithDomain:@"com.tt.rocket.stack_backtrace.symbolics" code:code userInfo:userInfo];
}
