...
typedef struct _wxrocket_dyld_image_ {
...
class WXRocketStackFrameSymbolics
{
  public:
    WXRocketStackFrameSymbolics();
    ~WXRocketStackFrameSymbolics();
  ...
  private:
    ...
    wxrocket_dyld_image *allImageInfo;
